        ...
        <main className="bg-gradient-to-br from-indigo-50 to-purple-100 py-16 px-4 md:px-8 lg:px-16">
            <div className="max-w-7xl mx-auto flex flex-col lg:flex-row items-center gap-12">
                <div className="lg:w-3/5">
                    <h1 className="text-[36px] sm:text-[28px] font-extrabold mb-6 text-gray-800 leading-tight">
                        Acerca De <span className="text-purple-600">Nosotros</span>
                    </h1>
                    <div className="bg-white rounded-2xl shadow-xl p-8 md:p-10 space-y-6">
                        <p className="text[26px] leading-relaxed text-gray-700">
                        ...
                        <p className="text[26px] font-semibold text-purple-600">
                            Únete a nosotros y descubre un mundo donde tu <span className="font-bold">imaginación</span> es el único límite.
                        </p>
                    </div>
                    <div className="mt-8 space-y-4">
                        <p className=" font-bold text-gray-800 text-[18px]">¿Ya tienes una cuenta? <span className="text-[18px] text-purple-600 font-extrabold">¡Juega ahora!</span></p>
