    ...
    return (
        <section className="py-16 px-4 md:px-8 lg:px-16">
            <div className="max-w-7xl mx-auto">
                <h2 className="text-display-md font-extrabold mb-10 text-gray-800 leading-tight">
                    Información de <span className="text-purple-600">Interés</span>
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div className="bg-white rounded-2xl shadow-xl p-8 space-y-4">
                        <h3 className="text-lg font-bold text-purple-600 tracking-wide">Reglas del Servidor</h3>
                        <ul className="text-base list-disc pl-5 text-gray-700 space-y-2">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 space-y-4">
                        <h3 className="text-lg font-bold text-purple-600 tracking-wide">Consejos de Rol</h3>
                        <ul className="text-base list-disc pl-5 text-gray-700 space-y-2">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 space-y-4">
                        <h3 className="text-lg font-bold text-purple-600 tracking-wide">Tutoriales</h3>
                        <p className="text-sm font-semibold text-gray-700">Visita nuestro canal de YouTube para acceder a tutoriales sobre:</p>
                        <ul className="text-base list-disc pl-5 text-gray-700 space-y-2">
