    ...
    return (
        <section className="bg-gradient-to-br from-indigo-50 to-purple-100 py-16 px-4 md:px-8 lg:px-16">
            <div className="max-w-7xl mx-auto">
                <h2 className="text-4xl md:text-5xl font-extrabold mb-10 text-gray-800 leading-tight">
                    Información de <span className="text-purple-600">Interés</span>
                </h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    <div className="bg-white rounded-2xl shadow-xl p-8 space-y-4">
                        <h3 className="text-2xl font-bold text-purple-600">Reglas del Servidor</h3>
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 space-y-4">
                        <h3 className="text-2xl font-bold text-purple-600">Consejos de Rol</h3>
                        <ul className="list-disc pl-5 text-gray-700 space-y-2">
                    ...
                    <div className="bg-white rounded-2xl shadow-xl p-8 space-y-4">
                        <h3 className="text-2xl font-bold text-purple-600">Tutoriales</h3>
                        <p className="text-gray-700">Visita nuestro canal de YouTube para acceder a tutoriales sobre:</p>
                        <ul className="list-disc pl-5 text-gray-700 space-y-2">
