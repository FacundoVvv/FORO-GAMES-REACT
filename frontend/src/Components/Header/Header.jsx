...
export const Header = () => {
  ...
  return (
    <header className="sticky top-0 z-50 bg-gradient-to-r from-purple-500 to-indigo-500 text-white p-8 h-[85px] flex items-center justify-between px-8 relative shadow-lg">
      <h1 className="text-3xl font-extrabold relative cool-title">
        <Link to='/'><span className='text-black'>SF</span>-RP</Link>
      </h1>
      <nav className="tracking-wide font-semibold hidden md:flex flex-grow justify-start space-x-8 ml-40">
      ...
      <div className="flex items-center space-x-4">
        {isLogged
          ...
          : <ul className="hidden md:flex space-x-4">
            <li><Link to='/login' className="hover:text-gray-300 font-bold transition duration-300 ease-in-out nav_links">Iniciar sesión</Link></li>
            <li><Link to='/register' className="bg-white text-purple-500 font-bold px-4 py-2 rounded-lg hover:bg-gray-100 transition duration-300 ease-in-out shadow-md">Registrarme</Link></li>
          </ul>
        }
