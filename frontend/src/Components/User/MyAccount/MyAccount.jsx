    ...
    return (
        <main className="bg-gradient-to-br from-indigo-50 to-purple-100 py-16 px-4 md:px-8 lg:px-16">
            <div className="max-w-5xl mx-auto bg-white rounded-2xl shadow-xl p-8 md:p-12 space-y-8">
                <h1 className="text-[32px] font-extrabold text-gray-800">Mi Cuenta</h1>

                {/* user info */}
                <section>
                    <h2 className="text-xl font-semibold text-purple-600 mb-4">Información Personal</h2>
                ...
                {/* change pass */}
                <section>
                    <h2 className="text-xl font-semibold text-purple-600 mb-4">Cambiar Contraseña</h2>
                    <Formik
                        initialValues={{
                            currentPassword: '',
                            newPassword: '',
                ...
                <section className="flex flex-col sm:flex-row gap-4 mt-8">
                    <button onClick={handleCloseSession} className="bg-gray-300 text-gray-800 font-bold py-3 px-6 rounded-lg hover:bg-gray-400 transition duration-300">
                        Cerrar Sesión
                    </button>
